...
import com.ecommerce.entity.UpdatePasswordRequest;
...
////////////////////////////
	 @PutMapping("/update-password")
	    public ResponseEntity<CommonApiResponse> updatePassword(@RequestBody UpdatePasswordRequest request) {
	        String email = request.getEmail();
	        String otp = request.getOtp();
	        String newPassword = request.getNewPassword();

	        // Validate OTP
	        if (!op.verifyOtp(email, otp)) {
	        ...
	        User user = userService.getUserByEmailAndStatus(email, UserStatus.ACTIVE.value());
	        if (user == null) {
